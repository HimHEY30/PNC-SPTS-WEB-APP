...
<template>
  <div class="flex h-screen overflow-hidden bg-slate-50">
    ...
    <div class="flex flex-1 flex-col overflow-hidden">
      ...
      <nav
        class="h-14 bg-white border-b border-slate-50 flex items-center justify-between px-4 shrink-0 z-40 relative"
      >
        ...
        <div class="flex items-center gap-4">
          ...
          <button
            class="relative w-8 h-8 rounded-full bg-white flex items-center justify-center text-[#64748b] border border-slate-50 hover:bg-gray-50 transition-colors"
          >
          ...
          <div>
            ...
            >
              <div
                class="relative w-7 h-7 rounded-full bg-[#3b4b6b] flex items-center justify-center overflow-hidden shrink-0 border border-slate-200 font-bold text-[10px] text-white select-none"
              >
                <img
              ...
              <div class="text-left leading-none hidden sm:block">
                ...
                <div class="flex items-center gap-1 mt-0.5">
                  ...
                  <span class="text-[9px] text-emerald-600 font-black uppercase tracking-wider">{{
                    auth.user?.entity_type || 'Online'
                  }}</span>
                </div>
              </div>
